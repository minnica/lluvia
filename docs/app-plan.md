...
**Pendiente para cerrar A4:** el proyecto Vercel no contiene claves TomTom; no se ha probado routing/geocodificación/mapa reales, permisos denegados, favoritos y comparación en el teléfono ni una actualización de la PWA. Tampoco se ha publicado esta copia. La precisión local continúa provisional.
